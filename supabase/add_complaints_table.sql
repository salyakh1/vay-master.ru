-- ВАЖНО: Выполняйте SQL по частям!
-- Сначала выполните: supabase/add_complaints_table_part1.sql
-- Затем выполните: supabase/add_complaints_table_part2.sql

-- Или выполните весь скрипт ниже целиком (если таблица еще не создана):
...
-- ЧАСТЬ 2: RLS политики (выполните после части 1)
