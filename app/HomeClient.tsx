...
const SpecializationCardsCarousel = dynamic(
  () => import('@/components/SpecializationCardsCarousel'),
  ...
  return (
    <div className="min-h-screen bg-bg-primary pb-20">
      ...
      <div className="container mx-auto px-4">
        <section className="max-w-4xl mx-auto text-center mb-12 pt-8 pb-8" style={{ minHeight: 'min-content' }}>
          ...
          {showGuestHero ? (
            <>
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                <Link href="/auth/register" className="btn btn-primary px-8 flex items-center justify-center gap-2">
                  <FiUser size={20} strokeWidth={2.5} />
                  Регистрироваться
                </Link>
                <Link href="/auth/login" className="btn btn-outline px-8 flex items-center justify-center gap-2">
                  <FiLogIn size={20} strokeWidth={2.5} />
                  Войти
                </Link>
              </div>
              <p className="text-sm text-text-muted">Сервис бесплатен для клиентов</p>
            </>
          ) : (
            <>
              <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                {user!.role === 'client' && (
                  <>
                    <Link href="/search" className="btn btn-primary px-8 flex items-center justify-center gap-2">
                      <FiSearch size={20} strokeWidth={2.5} />
                      Найти мастера
                    </Link>
                    <Link href="/orders" className="btn btn-outline px-8 flex items-center justify-center gap-2">
                      <FiBriefcase size={20} strokeWidth={2.5} />
                      Создать заказ
                    </Link>
                    <Link href="/products" className="btn btn-outline px-8 flex items-center justify-center gap-2">
                ...
                {user!.role === 'master' && (
                  <>
                    <Link href="/orders" className="btn btn-primary px-8 flex items-center justify-center gap-2">
                      <FiBriefcase size={20} strokeWidth={2.5} />
                      Найти заказы
                    </Link>
                    <Link href={`/profile/${user!.id}`} className="btn btn-outline px-8 flex items-center justify-center gap-2">
                      <FiUser size={20} strokeWidth={2.5} />
                      Мой профиль
                    </Link>
                    <Link href="/portfolio/new" className="btn btn-outline px-8 flex items-center justify-center gap-2">
                ...
                {user!.role === 'seller' && (
                  <>
                    <Link href="/products/new" className="btn btn-primary px-8 flex items-center justify-center gap-2">
                      <FiShoppingBag size={20} strokeWidth={2.5} />
                      Разместить товар
                    </Link>
                    <Link href="/products" className="btn btn-outline px-8 flex items-center justify-center gap-2">
        ...
        <SpecializationCardsCarousel
          initialCategories={initialCategories ?? undefined}
          initialTotalMasters={initialTotalMasters ?? undefined}
        />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-semibold text-graphite-secondary tracking-tight">Для мастеров</h3>
              </div>
            ...
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-semibold text-graphite-secondary tracking-tight">Для продавцов</h3>
              </div>
              <ul className="space-y-4 text-text-secondary leading-relaxed">
                <li className="flex items-start gap-3">
                  <FiCheckCircle size={20} className="text-brand-accent mt-0.5 flex-shrink-0" strokeWidth={2.5} />
            ...
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-semibold text-graphite-secondary tracking-tight">Для клиентов</h3>
              </div>
              <ul className="space-y-4 text-text-secondary leading-relaxed">
                <li className="flex items-start gap-3">
                  <FiCheckCircle size={20} className="text-brand-accent mt-0.5 flex-shrink-0" strokeWidth={2.5} />
        ...
        <section className="max-w-6xl mx-auto mb-32">
          ...
          <div className="space-y-6">
            {[1, 2, 3, 4, 5].map((n) => (
              <div key={n} className="card hover:shadow-card-hover transition-all">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-graphite-secondary mb-3 tracking-tight">
                      {n === 1 && 'Пользователь описывает задачу'}
                      {n === 2 && 'Платформа подсказывает, какие специалисты нужны'}
                      {n === 3 && 'Пользователь выбирает мастеров'}
                      {n === 4 && 'Подбор материалов и продавцов'}
                      {n === 5 && 'Выполнение работ и отзыв'}
                    </h3>
                    <p className="text-base text-text-secondary leading-relaxed">
                      {n === 1 && 'Строительство дома, ремонт квартиры, демонтаж и т.д. Подробное описание помогает найти нужного специалиста.'}
                      {n === 2 && 'Система анализирует задачу и рекомендует подходящих мастеров по специализациям.'}
                      {n === 3 && 'Сравнение профилей, просмотр портфолио, изучение отзывов и рейтингов для принятия решения.'}
                      {n === 4 && 'Встроенный каталог товаров позволяет найти нужные материалы и связаться с продавцами прямо в сервисе.'}
                      {n === 5 && 'После завершения проекта клиент оставляет отзыв, что помогает другим пользователям в выборе.'}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card hover:shadow-card-hover transition-all border-l-4 border-brand-accent">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-2 tracking-tight">Не знаю, с чего начать стройку</h3>
                  <p className="text-text-secondary leading-relaxed mb-3">VAY-MASTER подсказывает этапы работ и необходимых специалистов</p>
            ...
            <div className="card hover:shadow-card-hover transition-all border-l-4 border-brand-accent">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-2 tracking-tight">Страх обмана</h3>
                  <p className="text-text-secondary leading-relaxed mb-3">Система отзывов, рейтингов и жалоб обеспечивает безопасность сделок</p>
                  <div className="flex items-center gap-2 text-brand-accent font-medium">
                    <span>Защита</span>
            ...
            <div className="card hover:shadow-card-hover transition-all border-l-4 border-brand-accent">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-2 tracking-tight">Сложно найти нормального мастера</h3>
                  <p className="text-text-secondary leading-relaxed mb-3">Проверенные профили с портфолио и реальными отзывами клиентов</p>
                  <div className="flex items-center gap-2 text-brand-accent font-medium">
                    <span>Поиск</span>
            ...
            <div className="card hover:shadow-card-hover transition-all border-l-4 border-brand-accent">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-2 tracking-tight">Купил не те материалы</h3>
                  <p className="text-text-secondary leading-relaxed mb-3">Рекомендации специалистов и каталог проверенных продавцов</p>
                  <div className="flex items-center gap-2 text-brand-accent font-medium">
                    <span>Каталог</span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-3 tracking-tight">Модерация мастеров и продавцов</h3>
                  <p className="text-text-secondary leading-relaxed">Все профили проверяются администрацией перед публикацией. Проверка документов и портфолио.</p>
                </div>
              </div>
            </div>
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-3 tracking-tight">Система жалоб</h3>
                  <p className="text-text-secondary leading-relaxed">Быстрое реагирование на нарушения. Каждая жалоба рассматривается администрацией в течение 24 часов.</p>
                </div>
              </div>
            </div>
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-3 tracking-tight">Реальные отзывы</h3>
                  <p className="text-text-secondary leading-relaxed">Только от пользователей, выполнивших заказы. Невозможно оставить отзыв без завершённого проекта.</p>
                </div>
              </div>
            </div>
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-graphite-secondary mb-3 tracking-tight">Администрация платформы</h3>
                  <p className="text-text-secondary leading-relaxed">Контроль процессов и поддержка пользователей. Всегда на связи для решения вопросов.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {!user && (
          <section className="max-w-4xl mx-auto mb-24">
            <div className="card text-center bg-gradient-to-br from-bg-card to-bg-secondary border-2 border-brand-accent/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                <Link href="/search" className="btn btn-primary px-10 py-4 text-lg font-semibold flex items-center justify-center gap-2">
                  <FiSearch size={22} strokeWidth={2.5} />
                  Найти мастера
                </Link>
                <Link href="/auth/register" className="btn btn-outline px-10 py-4 text-lg font-semibold flex items-center justify-center gap-2">
                  <FiUser size={22} strokeWidth={2.5} />
                  Зарегистрироваться
                </Link>
                <Link href="/products" className="btn btn-outline px-10 py-4 text-lg font-semibold flex items-center justify-center gap-2">
